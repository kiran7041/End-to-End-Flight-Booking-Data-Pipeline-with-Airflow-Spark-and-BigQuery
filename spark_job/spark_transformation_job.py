...
def main(env, bq_project, bq_dataset, transformed_table, route_insights_table, origin_insights_table):
    try:
        ...
        input_path = f"gs://airflow-projetcs-kv/airflow-project-1/source-{env}"
        ...
        #since dataproc cluster and bigQuery are from same GCP environment. we dont need external jar files
