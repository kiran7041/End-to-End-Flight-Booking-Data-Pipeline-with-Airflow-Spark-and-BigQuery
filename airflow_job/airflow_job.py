...
with DAG(
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        google_cloud_conn_id="google_cloud_default",  # GCP connection , since our airflow is hosted on gcp
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "138363336315-compute@developer.gserviceaccount.com",
                "network_uri": "projects/proven-record-452706-g5/global/networks/default",
                "subnetwork_uri": "projects/proven-record-452706-g5/regions/us-east1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="proven-record-452706-g5",
        region="us-east1",
